...
public class Constance {
    ...
    public static final String QQ_APP_ID = "1107890483";
    ...
    // appid
    public static final String APP_ID = "wx7bbd31aa2468eb8c";// yum
    ...
    public static final String APP_SECRET="1de576fdd7fbea043b2b822fad4fc9eb";
    ...
    public static String high_quality_goods="high_quality_goods";
    public static String new_goods="new_goods";
    public static String hot_goods="hot_goods";
    public static String address_id="address_id";
    public static String spec_goods_price="spec_goods_price";
    ...
    public static String isXianHuo="xianhuo";
    public static String goods_content="goods_content";
    public static String password="password";
    public static String unionid="unionid";
    public static String code="code";
    public static String overlayAd="overlayAd";
    public static String filter_spec="filter_spec";
    public static String filter_price="filter_price";
    public static String categoryList="categoryList";
    public static String shipping_code="shipping_code";
    public static String invoice_no="invoice_no";
    public static String sex="sex";
    public static String favourite_goods="favourite_goods";
    public static String isFont="isFont";
    public static String RegistrationID="RegistrationID";
    public static String count="count";
    public static String qianggou="qianggou";
    public static String goods_spec_list="goods_spec_list";
    public static String prom_type="prom_type";
    public static String property_name="property_name";
    public static String isActivity="isActivity";
    public static String third_oauth="third_oauth";
    public static String access_token="access_token";
    public static String headimgurl="headimgurl";
    public static String figureurl_qq_2="figureurl_qq_2";
