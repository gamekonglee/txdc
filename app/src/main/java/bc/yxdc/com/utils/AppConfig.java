...
//    }
    ...
    public static void setValue(String key, String value) {
        ...
        synchronized (lock) {
            SharedPreferences sp = IssApplication.getInstance().getSharedPreferences("b7app", IssApplication.getContext().MODE_PRIVATE);
...
//        synchronized (lock) {
////            SharedPreferences sp = IssApplication.getInstance().getSharedPreferences("b7app", IssApplication.getContext().MODE_PRIVATE);
//            ret=ConfigUtil.getInstance(IssApplication.getContext()).getString(Constance.TOKEN);
//        }
//
//        //return
//        return ret;
