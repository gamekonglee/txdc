...
import bc.yxdc.com.inter.ISingleTouchViewListener;
...
public class SingleTouchView extends View {
    ...
    private void init(){
        ...
        if(controlDrawable == null){
            controlDrawable = getContext().getResources().getDrawable(R.mipmap.ls_icon);
        }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction() ) {
            case MotionEvent.ACTION_DOWN:
                ...
                IssApplication.mLightIndex=mLightCount;
